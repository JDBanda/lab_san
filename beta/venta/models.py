...
class Sucursal(models.Model):
    sucu_nombre = models.CharField("Nombre de sucursal", max_length=100)
    sucu_especialidad = models.CharField("Especialidad", max_length=100)

class Paciente(models.Model):
    paci_apellidoPaterno = models.CharField("Apellido paterno", max_length=30)
    paci_apellidoMaterno = models.CharField("Apellido materno", max_length=30)
    paci_nombre = models.CharField("Nombre(s)", max_length=50)
    paci_direccion = models.CharField("Dirección", max_length=100)
...
class Medico(models.Model):
    medi_apellidoPaterno = models.CharField("Apellido paterno", max_length=30)
    medi_apellidoMaterno = models.CharField("Apellido materno", max_length=30)
    medi_nombre = models.CharField("Nombre(s)", max_length=50)
    medi_direccion = models.CharField("Dirección", max_length=150)
...
class Usuario(models.Model):
    usua_apellidoPaterno = models.CharField(max_length=30)
    usua_apellidoMaterno = models.CharField(max_length=30)
    usua_nombre = models.CharField(max_length=50)
    usua_direccion = models.CharField(max_length=150)
...
class Categoria(models.Model):
    cate_nombre = models.CharField("Categoria", max_length=100)
...
class modoPago(models.Model):
    modo_nombre = models.CharField("Modo de pago", max_length=150)
...
class Status(models.Model):
    status_nombre = models.CharField("Estatus", max_length=150)
...
class Servicio(models.Model):
    serv_nombre = models.CharField("Nombre del servicio", max_length=150)
    ...
    serv_codigobarra = models.CharField("Codigo de barras", max_length=150)
...
class NotaDeVenta(models.Model):
    ...
    nota_idUsuario = models.CharField(max_length=150, null=True)
    ...
    nota_entrega = models.CharField("quien recibe", max_length=150)
